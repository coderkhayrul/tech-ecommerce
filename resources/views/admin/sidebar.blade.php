    ...
    <div class="sl-sideleft-menu">
        ...
        @if (Auth::user()->category == 1)
            ...
            <ul class="sl-menu-sub nav flex-column">
                ...
                <li class="nav-item"><a href="{{ route('admin.sub.categories') }}" class="nav-link">Sub Categories</a>
                </li>
        ...
        @if (Auth::user()->order == 1)
            ...
            <ul class="sl-menu-sub nav flex-column">
                ...
                <li class="nav-item"><a href="{{ route('admin.order.accept.list') }}" class="nav-link">Accepted
                        Payment</a></li>
                <li class="nav-item"><a href="{{ route('admin.order.process.list') }}" class="nav-link">Process
                        Delivery</a>
                </li>
        ...
        @if (Auth::user()->blog == 1)
            ...
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{ route('admin.all.blog.category') }}" class="nav-link">Post
                        Category</a>
                </li>
        ...
        @if (Auth::user()->report == 1)
            ...
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{ route('admin.today.order') }}" class="nav-link">Today Order</a>
                </li>
                <li class="nav-item"><a href="{{ route('admin.today.delivery') }}" class="nav-link">Today
                        Delivery</a>
                </li>
                <li class="nav-item"><a href="{{ route('admin.this.month') }}" class="nav-link">This Month
                        Report</a>
                </li>
        ...
        @if (Auth::user()->return == 1)
            ...
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{ route('admin.return.request') }}" class="nav-link">Return
                        Request</a></li>
                <li class="nav-item"><a href="{{ route('admin.all.return.request') }}" class="nav-link">All
                        Request</a></li>
            </ul>
        @endif
        @if (Auth::user()->contact == 1)
            ...
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{ route('admin.all.message') }}" class="nav-link">All Message</a>
                </li>
            </ul>
        @endif
