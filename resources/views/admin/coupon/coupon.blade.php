                    ...
                    <table id="datatable1" class="table display responsive nowrap">
                        <thead>
                            <tr>
                                ...
                                <th class="wd-20p">Coupon Percentage</th>
                        ...
                        <tbody>
                            @foreach ($coupons as $key => $row)
                                <tr>
                                    <td>{{ $key + 1 }}</td>
                                    <td class="text-uppercase">{{ $row->coupon }}</td>
                                    <td>{{ $row->discount }} %</td>
                                    <td>
                                        <a href="{{ route('admin.edit.coupon', $row->id) }}"
                                            class="btn btn-sm btn-info">Edit</a>
                                        <a id="delete" href="{{ route('admin.delete.coupon', $row->id) }}"
