...
@section('content')
                                        ...
                                        <div class="deals_content">
                                            <div class="deals_info_line d-flex flex-row justify-content-start">
                                                <div class="deals_item_category"><a
                                                        href="#">{{ $hot->brand_name }}</a></div>
                                                <div class="deals_item_price_a ml-auto">
                                                    @if ($hot->discount_price == null)
                                                    @else
                                                        <div class="deals_item_price ml-auto">${{ $hot->selling_price }}
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="deals_info_line d-flex flex-row justify-content-start">
                                                ...
                                                <div class="deals_item_price ml-auto">
                                                    ...
                                                    @endif
                                                    @if ($hot->discount_price != null)
                                                        <div class="deals_item_price ml-auto">${{ $hot->discount_price }}
                                                        </div>
                                                    @else
                                                    @endif
                                                </div>
                                        ...
                                        <div class="featured_slider_item">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <img class="slider_product_panel_size"
                                                ...
                                                <div class="product_content">
                                                    ...
                                                    <div class="product_name">
                                                        <div><a
                                                                href="{{ url('product/details/' . $row->id) . '/' . $row->product_name }}">{{ Str::limit($row->product_name, 15, '..') }}</a>
                                                        </div>
                                                    </div>
                                ...
                                <div class="row fill_height">
                                    <div class="col-lg-4 col-md-6 fill_height">
                                        <div class="banner_2_content">
                                            ...
                                            <div class="banner_2_text">
                                                <h4>{{ $row->brand_name }}</h4> <br>${{ $row->selling_price }}
                                            </div>
                                    ...
                                    <div class="col-lg-8 col-md-6 fill_height">
                                        <div class="banner_2_image_container">
                                            <div class="banner_2_image"><img src="{{ asset($row->image_one) }}"
                                                    alt="" style="height: 300px; width: 250px;"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    @php
        $categorytwo = DB::table('categories')
            ->skip(2)
            ->first();
        $producttwo = DB::table('products')
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="tabbed_container">
                        <div class="tabs clearfix tabs-right">
                            <div class="new_arrivals_title">{{ $categorytwo->category_name }}</div>
                            <ul class="clearfix">
                                <li class="active"></li>
                            </ul>
                            <div class="tabs_line"><span></span></div>
                                        ...
                                        <div class="trends_content">
                                            ...
                                            <div class="trends_info clearfix">
                                                <div class="trends_name"><a
                                                        href="product.html">{{ $row->product_name }}</a></div>
    ...
    <div class="modal fade" id="cartModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
        <div class="modal-dialog" role="document" style="max-width: 850px; margin: 150px auto;">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-4 text-center">
                            <div class="card">
                                <img class="text-center" id="pimage" src="" alt=""
                        ...
                        <div class="col-md-4">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item">Stock: <span class="badge"
                                        style="background-color: green; color:white;"> Available</span></li>
                            </ul>
                        </div>
                        <div class="col-md-4">
                            <form action="{{ route('insert.into.cart') }}" method="POST">
                                ...
                                <div class="form-group">
                                    <label class="control-label" for="exampleInputcolor">Color</label>
                                    <select name="color" class="form-control" name="color"
                                        id="color"></select>
                                </div>

                                <div class="form-group">
                                    <label class="control-label" for="exampleInputsize">Size</label>
                                    <select class="form-control" name="size" id="size"></select>
                                </div>

                                <div class="form-group">
                                    <label class="control-label" for="exampleInputsize">Quantity</label>
        ...
        function productview(id) {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    // Color
                    var color = $('select[name="color"]').empty();
                    $.each(data.color, function(key, value) {
                        $('select[name="color"]').append('<option value="' + value + '">' + value +
                            '</option>');
                    });
                    // Size
                    var size = $('select[name="size"]').empty();
