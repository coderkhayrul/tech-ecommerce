                                ...
                                <div class="product_item discount">
                                    ...
                                    <div class="product_content">
                                        @if ($pro->discount_price == null)
                                            <div class="product_price" style="color:black;">${{ $pro->selling_price }}
                                            </div>
                                        @else
                                            <div class="product_price">
                                                ${{ $pro->selling_price }}<span>${{ $pro->discount_price }}</span></div>
                                        @endif
                                        <div class="product_name">
                                            <div><a href="{{ url('product/details/' . $pro->id) . '/' . $pro->product_name }}"
                                                    tabindex="0">{{ Str::limit($pro->product_name, 15, '..') }}</a>
                                            </div>
                                        </div>
                                    </div>
