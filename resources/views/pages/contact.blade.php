...
@section('content')
    ...
    <!-- Contact Info -->
    @php($site = \Illuminate\Support\Facades\DB::table('sitesetting')->first())
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="contact_form_container">
                        ...
                        <form action="{{ route('web.contact.store') }}" id="contact_form" method="POST">
                            @csrf
                            <div class="contact_form_inputs d-flex flex-md-row flex-column justify-content-between align-items-between">
                                ...
                                <input name="phone" type="text" id="contact_form_phone" class="contact_form_phone input_field" placeholder="Your phone number">
                            </div>
